    ...
    fields: {
        ...
        NewsFeed: {
            ...
            async resolve(parent, args) {
                ...
                console.log(q)
                let size = args.limit;
                let hit_url = new URL('https://newsapi.org/v2/everything')
                var params = { sortBy: 'publishedAt' , apiKey: '58700e97a495469996792adb1f746fa3' , q , pageSize:size}
                hit_url.search = new URLSearchParams(params)

                return fetch(hit_url).then(res => res.json())
                    .then(json => {
